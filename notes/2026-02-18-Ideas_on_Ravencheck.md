...
4. Finding missing instantiations is a big problem in current version of Ravencheck. When we try to complex inductive properties, it is often the case. However, what if we do not delve into inductive problems, and do some regular verification, such as case study 6.2 and 6.3 of our OOPSLA paper? Maybe automatically inferring axioms for uninterpreted functions would be more useful in this case..